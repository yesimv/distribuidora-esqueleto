<header
  ...
  <div
    ...
    <div
      class=" flex w-full items-center justify-end lg:hidden gap-2 border-b border-gray-200 px-3 py-3 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4 dark:border-gray-800">
      <!-- Hamburger Toggle BTN -->
      <button
        :class="sidebarToggle ? 'lg:bg-transparent ' : 'dark:lg:bg-transparent '"  x-cloak
        class=" z-99999 flex h-10 w-10 items-center justify-center rounded-lg dark:bg-gray-800  bg-gray-100 border-gray-200 text-gray-500 lg:h-11 lg:w-11 lg:border dark:border-gray-800 dark:text-gray-400"
        ...
        <!-- cross icon -->
          <svg
            :class="!sidebarToggle ? 'hidden' : 'block lg:hidden'"  x-cloak
            class="fill-current"
            width="24"
            height="24"
            viewBox="0 0 24 24"
    ...
    <div
      :class="menuToggle ? 'flex' : 'hidden'" x-cloak
                ...
                <a
                  ...
                  <span class="block">
                    <span
                      ...
                      <span class="font-medium text-gray-800 dark:text-white/90">Proyecto - Nganter App</span>
                    </span>
      ...
      <div
        ...
        <a
          ...
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="assets/img/user/owner.jpg" alt="User" />
          </span>

          <span class="text-theme-sm mr-1 block font-medium"> <?php echo $_SESSION['username']; ?> </span>
        ...
        <div
          x-cloak
          x-show="dropdownOpen"
          class="shadow-theme-lg dark:bg-gray-dark absolute right-0 mt-[17px] flex w-[300px] flex-col rounded-2xl border border-gray-200 bg-white p-3 dark:border-gray-800 ">
          <div>
            <span
          ...
          <a
            href=<?php
                  ...
                  echo Config::get('app.base_url') . "/api/logout" ?>
