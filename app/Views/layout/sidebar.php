            ...
            <ul class="flex flex-col gap-4 mb-6">
              ...
              <li>
                ...
                <div
                  ...
                  <ul
                    ...
                    <li>
                      <a
                        href=<?php echo Config::get('app.base_url') . "/sistema-ticket" ?>
                        class="menu-dropdown-item group"
              ...
              <li>
                <a
                  ...
                  <svg
                    :class="(selected === 'Tickets') || (page === 'formElements' || page === 'formLayout' || page === 'proFormElements' || page === 'proFormLayout') ? 'menu-item-icon-active'  :'menu-item-icon-inactive'"
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
                    fill="none"
                  ...
                  <svg
                    class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                    :class="[(selected === 'Tickets') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
              ...
              <li>
                <a
                  ...
                  <svg
                    class="menu-item-arrow absolute right-2.5 top-1/2 -translate-y-1/2 stroke-current"
                    :class="[(selected === 'Analisis') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                    fill="none"
              ...
              <li>
                ...
                <div
                  ...
                  <ul
                    ...
                    <li>
                      <a
                        href=<?php echo Config::get('app.base_url') . "/data-table" ?>
                        class="menu-dropdown-item group"
                        :class="page === 'allTickets' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
