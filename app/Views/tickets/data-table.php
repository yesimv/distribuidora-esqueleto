              ...
              <div class="space-y-5 sm:space-y-6">
                          ...
                          <div x-data="dataTableThree()"
                              ...
                              <div class="mb-4 flex flex-col gap-2 px-4 sm:flex-row sm:items-center sm:justify-between">
                                  <div class="flex items-center gap-3">
                                      ...
                                      <span class="text-gray-500 dark:text-gray-400"> entradas </span>
                                  </div>
                              ...
                              <div class="max-w-full overflow-x-auto">
                                  <div class="min-w-[1102px]">
                                      ...
                                      <!-- table body start -->
                                      <template x-for="person in paginatedData" :key="person.id"></template>
                                      <div x-data="{ checkboxToggle: false }"
                                              ...
                                              <div class="flex gap-3">
                                                  ...
                                                  <div>
                                                      ...
                                                      <span class="text-sm text-gray-500 dark:text-gray-400"
                                                          x-text="person.email">demoemail@gmail.com</span>
                                                  </div>
                                              </div>
                                          </div>
                                          <div
                                              class="col-span-3 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.position">Software
                                                  Engineer</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.salary">$89,500</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.office">Edinburgh</p>
                                          </div>
                                          <div
                                              ...
                                              <p :class="{
                                                  ...
                                                  class="text-theme-xs rounded-full px-2 py-0.5 font-medium bg-success-50 dark:bg-success-500/15 text-success-700 dark:text-success-500"
                                                  x-text="person.status">Hired</p>
                                          </div>
                                      ...
                                      <div x-data="{ checkboxToggle: false }"
                                          ...
                                          <div
                                              class="col-span-3 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.position">Integration
                                                  Specialist</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.salary">$15,500</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.office">London</p>
                                          </div>
                                          <div
                                              class="col-span-1 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p :class="{
                                                    ...
                                                    &#39;bg-warning-50 dark:bg-warning-500/15 text-warning-700 dark:text-orange-400&#39;: person.status === &#39;In Progress&#39;,
                                                    &#39;bg-error-50 dark:bg-error-500/15 text-error-700 dark:text-error-500&#39;: person.status === &#39;Pending&#39;
                                                    }" class="text-theme-xs rounded-full px-2 py-0.5 font-medium bg-error-50 dark:bg-error-500/15 text-error-700 dark:text-error-500"
                                                  x-text="person.status">Pending</p>
                                          </div>
                  ...
                  &#39;bg-error-50 dark:bg-error-500/15 text-error-700 dark:text-error-500&#39;: person.status === &#39;Pending&#39;
                                      ...
                                      <div x-data="{ checkboxToggle: false }"
                                          ...
                                          <div
                                              class="col-span-3 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.position">Sales
                                                  Assistant</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.salary">$19,200</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.office">San Francisco
                                              </p>
                                          </div>
                                          <div
                                              class="col-span-1 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                  ...
                  &#39;bg-error-50 dark:bg-error-500/15 text-error-700 dark:text-error-500&#39;: person.status === &#39;Pending&#39;
                                      ...
                                      <div x-data="{ checkboxToggle: false }"
                                          ...
                                          <div
                                              class="col-span-3 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.position">Pre-Sales
                                                  Support</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                                              <p class="text-theme-sm text-gray-700 dark:text-gray-400" x-text="person.salary">$23,500</p>
                                          </div>
                                          <div
                                              class="col-span-2 flex items-center border-r border-gray-100 px-4 py-3 dark:border-gray-800">
                              ...
                              <div class="border-t border-gray-100 py-4 pr-4 pl-[18px] dark:border-gray-800">
                                  <div class="flex flex-col xl:flex-row xl:items-center xl:justify-between">
                                      <p
                                          ...
                                          Mostrando <span x-text="startEntry">1</span> de
                                          <span x-text="endEntry">10</span> de
                                          <span x-text="totalEntries">30</span> resultados
                                      </p>
                                      <div class="flex items-center justify-center gap-0.5 pt-3 xl:justify-end xl:pt-0">
                                          <button @click="prevPage()"
                                              class="shadow-theme-xs mr-2.5 flex items-center justify-center rounded-lg border border-gray-300 bg-white px-3.5 py-2.5 text-gray-700 hover:bg-gray-50 disabled:opacity-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03]"
                                          ...
                                          <button @click="goToPage(1)"
                                              ...
                                              class="hover:text-brand-500 dark:hover:text-brand-500 flex h-10 w-10 items-center justify-center rounded-lg text-sm font-medium hover:bg-blue-500/[0.08] bg-blue-500/[0.08] text-brand-500">
                                              1
                                          </button>

                                          <template x-if="currentPage &gt; 3"></template>

                                          <template x-for="page in pagesAroundCurrent" :key="page"></template><button
                                              @click="goToPage(page)"
                                          ...
                                          <template x-if="currentPage &lt; totalPages - 2"></template>
