            ...
            <div class="grid grid-cols-1 gap-4  ">
              <div class="space-y-6 ">
                ...
                <div
                  ...
                  <div class="">
                    <div id='formulario-ticket-editar'
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          id="departamentoSolInput"
                          disabled
                          class="select-disable dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 px-4 py-2.5 text-sm text-gray-800 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" />
                      </div>
                  ...
                  <div class=" border-y  border-gray-100 p-5    dark:border-gray-800  gap-4   flex justify-end  ">
                    ...
                    <button
                      id='btn-formulario-ticket-editar'
                      class="  btn-primary">
                      Actualizar
                    </button>
