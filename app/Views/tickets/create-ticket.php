              ...
              <div class="space-y-6 ">
                ...
                <div
                  ...
                  <div class="">
                    ...
                    <div
                      class=" border-gray-100 p-5 border-y sm:p-6  dark:border-gray-800 grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-4 items-center ">
                      <!-- Empleado asignado -->
                      <div class="         ">
                        <label
                          class="mb-1.5 text-sm font-medium text-gray-700 dark:text-gray-400">
                  ...
                  <div class=" border-y  border-gray-100 p-5    dark:border-gray-800       ">
                    ...
                    <button
                      id='btn-formulatio-ticket-nuevo'
                      class="  btn-primary">
                      Crear ticket
                    </button>
                  </div>
