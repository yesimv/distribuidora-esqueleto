...
<head>
  ...
  <title>Iniciar Sesión | Masterfuel Connect</title>
...
<body
          ...
          <div>
            <div class="mb-5 sm:mb-8">
              ...
              <p class="text-sm text-gray-500 dark:text-gray-400">
                Ingresa tu ususario y contraseña para iniciar sesion.
              </p>
            </div>
            <div>
              ...
              <form method="post" id="formulario-login" novalidate>
                <div class="space-y-5">
                  <!-- Email aqui pendiente -->
                  <div>
                    <label
                    ...
                    <input
                      ...
                      class="input dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                    <p id="error-email" class="text-brand-500 text-sm mt-1 hidden"></p>
                  </div>
                  <!-- Password -->
                  <div>
                    <label
                    ...
                    <div x-data="{ showPassword: false }" class="relative">
                      <input
                        ...
                        class="input dark:bg-dark-900 h-11 w-full rounded-lg border border-gray-300 bg-transparent py-2.5 pl-4 pr-11 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800" />
                      <p id="error-password" class="text-brand-500 text-sm mt-1 hidden"></p>
                      <span
              ...
              <div class="mt-5">
                <p
                  ...
                  <a
                    href="/signup"
                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Crear una cuenta</a>
                </p>
              </div>
            </div>
          </div>
  ...
  <script type="module" src="src/js/modules/auth/signin.js"></script>
</body>
