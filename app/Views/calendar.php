  ...
  <nav>
    <ol class="flex items-center gap-1.5">
      ...
      ></li>
            ...
            <!-- BEGIN MODAL -->
            <div
  class="fixed inset-0 items-center justify-center hidden p-5 overflow-y-auto modalz-"
  id="eventModal"
>
  <div
...
<!-- <div
  class="modal fixed left-0 top-0z- hidden min-h-screen w-full justify-center overflow-y-auto overflow-x-hidden bg-gray-400/50 px-4 py-4 backdrop-blur-[32px] lg:py-[120px]"
  id="eventModal"
>
</div> -->
<!-- END MODAL -->
    ...
    <!-- ===== Page Wrapper End ===== -->
  <script defer src="assets/js/bundle.js"></script></body>
</html>
